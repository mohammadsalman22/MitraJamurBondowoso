                ...
                <div class="col-lg-12">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h4 class="m-0 font-weight-bold text-primary">Edit Kontak</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('kontak.update', $kontak->id_kontak) }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mb-3" id="nama" value="{{ $kontak->nama }}"
                                        name="nama">
                                </div>
                                <div class="form-group">
                                    <label for="logo">Logo kontak</label>
                                    <input type="file" class="form-control-file mb-3" id="logo" name="logo"
                                        value="{{ $kontak->logo }}"><br>
                                    <div class="d-flex align-items-start mb-3">
                                        <img width="100px" height="100px" src="{{ url('' . $kontak->logo) }}"
                                            alt=" {{ $kontak->name }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="kontak">Kontak</label>
                                    <input type="text" class="form-control mb-3" id="kontak" value="{{ $kontak->kontak }}"
                                        name="kontak">
                                </div>
